...
describe('Functor', function() {
  describe('#map', function() {
    ...
    it('should map over a custom functor', function() {
      const functor = {map:function(funct) { return funct(3) + 1;}};
  ...
  describe('#pipeline2', function() {
    it('should sequentially apply the maps', function() {
      const multiplyByTwo = function(a:number) { return a * 2; };
      const subtractByTwo = function(a:number) { return a - 2; };

      const result = Functor.pipeline2([1,2,3],
                                     multiplyByTwo,
                                     subtractByTwo);
  ...
  describe('#pipeline3', function() {
    it('should sequentially apply the maps', function() {
      ...
      const result = Functor.pipeline3([1,2,3],
                                     multiplyByTwo,
                                     subtractByTwo,
                                     subtractByTwo);
  ...
  describe('#pipeline4', function() {
    it('should sequentially apply the maps', function() {
      ...
      const result = Functor.pipeline4([1,2,3],
                                     multiplyByTwo,
                                     subtractByTwo,
                                     subtractByTwo,
                                     multiplyByTwo);
  ...
  describe('#pipeline5', function() {
    it('should sequentially apply the maps', function() {
      ...
      const result = Functor.pipeline5([1,2,3],
                                     multiplyByTwo,
                                     subtractByTwo,
                                     subtractByTwo,
                                     multiplyByTwo,
  ...
  describe('#pipeline6', function() {
    it('should sequentially apply the maps', function() {
      ...
      const result = Functor.pipeline6([1, 2, 3],
                                     multiplyByTwo,
                                     subtractByTwo,
                                     subtractByTwo,
                                     multiplyByTwo,
